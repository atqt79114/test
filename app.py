...
3.  **🕸️ 日線極度糾結 (潛伏版)**：
    * **核心**：5/10/20/60 MA 四條均線**現在**黏在一起 (寬度 < 3.5%)。
    * **型態**：股價波動小 (乖離 < 1.5%)，正在等待變盤。
    * **濾網**：排除低價股 (<10元) 與 低量股。
